...
if __name__ == '__main__':
    ...
    with open("data/HIPE-data-v1.4-test-de.tsv", encoding='utf-8') as f:
        ...
        print_processed_lines_to_file('data/HIPE-data-v1.4-test_de_OPENTAPIOCA.tsv', 'EL_OPENTAPIOCA', header)
        ...
        for line in tsv_reader:
            ...
            if len(line) > 0 and '#' not in line[0]:
                if "PySBDSegment" not in line[9]:
                    ...
                    print_processed_lines_to_file('data/HIPE-data-v1.4-test_de_OPENTAPIOCA.tsv', 'EL_OPENTAPIOCA', segment_lines)
                    segment = ''
                    segment_lines = []
                    print('--------------------')
